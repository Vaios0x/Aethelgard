...
function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-background/70 backdrop-blur border-b border-white/5">
      <nav className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between" aria-label="Principal">
        ...
        <div className="flex items-center gap-2">
          <Link to="/dashboard" className="relative px-3 py-2 rounded-md hover:bg-white/5" aria-label="Actividad reciente">
            <span>Actividad</span>
            {items.length > 0 && (
