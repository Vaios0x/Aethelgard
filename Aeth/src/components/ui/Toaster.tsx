...
export default function Toaster() {
  ...
  return (
    <div className="fixed bottom-2 sm:bottom-4 right-2 sm:right-4 z-[100] space-y-2 w-[calc(100vw-1rem)] sm:w-[92vw] max-w-sm" role="region" aria-live="polite">
      {toasts.map((t) => (
        <div key={t.id} className={`rounded-md px-3 sm:px-4 py-2 sm:py-3 shadow-glow border ${
